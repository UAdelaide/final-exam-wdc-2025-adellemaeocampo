...
VALUES ((SELECT user_id FROM Users WHERE username = 'alice123'), 'Max', 'medium'),
       ...
       ((SELECT user_id FROM Users WHERE username = 'carol123'), 'Mochi', 'large'),
...
VALUES ((SELECT dog_id FROM Dogs WHERE name = 'Max'), '2025-06-10 08:00:00', 30, 'Parklands', 'open'),
       ...
       ((SELECT dog_id FROM Dogs WHERE name = 'Mochi'), '2025-06-10 10:30:00', 25, 'Glenelg', 'cancelled'),
       ((SELECT dog_id FROM Dogs WHERE name = 'Astro'), '2025-06-20 11:30:00', 60, 'Adelaide', 'accepted'),
       ((SELECT dog_id FROM Dogs WHERE name = 'Jelly'), '2025-06-10 12:30:00', 60, 'Stirling', 'cancelled'),
